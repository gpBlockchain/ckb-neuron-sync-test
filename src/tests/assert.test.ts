...
describe('query sqlite3', function () {
    ...
    it.skip("query blake160 of asset_account", async () => {
        const fullNode_dbPath = "data/fullNode/wallet1/cell-0x9c96d0b369b5fd42d7e6b30d6dfdb46e32dac7293bf84de9d1e2d11ca7930717.sqlite";
    ...
    it.skip("compare old to new asset_account", async () => {
        ...
        const dbPath1 = "data/fullNode/wallet1/cell-0x9c96d0b369b5fd42d7e6b30d6dfdb46e32dac7293bf84de9d1e2d11ca7930717.sqlite";
